...
@onready var sprite = $animaciones/AnimationPlayer
@onready var raycast = $RayCast2D
@onready var sonido = $AudioStreamPlayer2D
@onready var marker = $Marker2D

# Pre-carga de la escena de la bala
var bullet_scene = preload("res://Cosas_Enemigos/Trampa_Torreta/bala_de_madera_derecha.tscn")
var trozo_1 = preload("res://Cosas_Enemigos/Trampa_Torreta/trozo_1.tscn")
...
var can_shoot = true
var shoot_cooldown = 2.0  # Tiempo entre disparos en segundos
var shoot_timer = 0.0
